export const siteConfig = {
  ...
  firm: {
    ...
    whatsappNumber: "917382041516",
    whatsappMessage: "Hello PNC Law Associates, I would like to book a consultation regarding my legal matter.",
    email: "contact@pncjustice.com",
